...
"</select>"}h[b].editoptions.title||(h[b].editoptions.title="");table_elements=$("<tr />").attr({id:"tr_"+h[b].index,"class":"FormData",title:h[b].editoptions.title,style:h[b].hidden?"display:none":""});table_elements.append($("<td />").attr({"class":"CaptionTD",style:"width:150px;"}).append(t[b]));table_elements.append($("<td />").attr({"class":"DataTD",style:"white-space:nowrap;"}).append(a));u.append(table_elements)}});if($.isFunction(create_from_table_elements)){$.isFunction(replace_select_opt_group)&&

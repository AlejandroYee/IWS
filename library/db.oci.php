...
if (!defined("DB_USER_NAME") or !defined("DB_PASSWORD") or !defined("DB_NAME") or !defined("DB_ENCODING")) die("Для работы системы IWS с БД ORACLE нужно указать параметры подключения в конфигурационном файле");
...
private $arhive_sql,$vields_sql = [];
	...
	public function get_realname() {		
		...
		if (count($names) > 1) {
                            if (isset($names[2]) and trim(mb_substr($names[2],0,1,HTML_ENCODING)) != "") {

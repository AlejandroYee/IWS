/*
 ...
 Part of IWS system
*/
jQuery.uiBackCompat=!1;jQuery.jgrid.no_legacy_api=!0;var counttab=1,sumtab=0,alert_enabled=0,hidden_menu=!1,user_not_logget=!0,main_menu_higth,enable_menu=!1,slidebar="left",doc_height,doc_width,doc_title=null;
$(function(){redraw_document=function(b){$("body").width(doc_width).height(doc_height);$(".user_login").css({top:doc_height/2-175,left:doc_width/2-200});$.browser.msie&&$(".post_form_login").css("top","110px");"undefined"===typeof b&&(b=$($(".ui-tabs-panel[aria-hidden='false']")));if(b.attr("need_redraw")||0===b.length)$("#tabs").tabs().height(doc_height-main_menu_higth-10),$("#tabs .ui-tabs-panel").height(doc_height-main_menu_higth-10).width(doc_width-20),$(".about_tabs").offset({top:doc_height-
...
0<alert_enabled&&(alert_enabled=0,$(".navigation_header .alert_button").remove())};custom_alert=function(b){title_msg="\u0412\u043d\u0438\u043c\u0430\u043d\u0438\u0435:";-1!==b.search("ORA-")&&(title_msg="SQL \u041e\u0448\u0438\u0431\u043a\u0430 \u043a\u043e\u043d\u0444\u0438\u0433\u0443\u0440\u0430\u0446\u0438\u0438:");-1!==b.search("\u0437\u0430\u043f\u0440\u0435\u0449\u0435\u043d")&&(title_msg="\u0410\u0443\u043d\u0442\u0435\u0444\u0438\u043a\u0430\u0446\u0438\u044f:");b||(b="");$("<div />").html(b).dialog({title:title_msg,
resizable:!1,minWidth:450,modal:!0,dialogClass:"alert",buttons:{"\u0417\u0430\u043a\u0440\u044b\u0442\u044c":function(){$(this).dialog("close")}},open:function(){$(this).parent().css("z-index",9999).parent().children(".ui-widget-overlay").css("z-index",105)}})};trim_text=function(b,a,d){var c="";if(b.length<a)return b;b=b.split(" ");for(a=0;a<b.length;a++)if(c=c+" "+b[a],a>d-2)return c+"..."};plot_graph=function(b){$.ajax({url:b.attr("url"),type:"GET",success:function(a){"Not autorised"===a&&$(location).prop("href",
location.href);a=jQuery.parseJSON(a);var d=$("#"+b.attr("id")),c={canvas:!0,grid:{hoverable:!0,clickable:!0},legend:{backgroundOpacity:.8,show:a.legend},xaxis:a.xaxis,yaxes:a.yaxis,zoom:{interactive:!0},pan:{interactive:!1},crosshair:{mode:"xy"}};$.extend(c,a.options);0===b.children().length?($.plot(d,a.data,c),d.bind("plothover",function(b,a,c){a=d.is(":ui-tooltip");b=$.ui.tooltip.prototype.options.position;null!==c&&!1===a?(a=c.series.label+": "+c.series.data[c.dataIndex][0]+", "+c.datapoint[1],
c=$.extend(b,{of:{pageX:c.pageX,pageY:c.pageY,preventDefault:$.noop}}),d.tooltip({position:c,content:a,items:"*"}).tooltip("open")):null===c&&!0===a&&d.tooltip("destroy")}),$("<div><b>"+a.chart_label+"</b></div>").insertBefore(b)):$.plot(d,a.data,c);0<a.xaxis.labelAngle&&b.find(".flot-x-axis").children(".flot-tick-label").css({"-webkit-transform":"translateX(50%) rotate("+a.xaxis.labelAngle+"deg)","-moz-transform":"translateX(50%) rotate("+a.xaxis.labelAngle+"deg)","-ms-transform":"translateX(50%) rotate("+
a.xaxis.labelAngle+"deg)","-o-transform":"translateX(50%) rotate("+a.xaxis.labelAngle+"deg)",transform:"translateX(50%) rotate("+a.xaxis.labelAngle+"deg)","transform-origin":"3px 3px 0px","-ms-transform-origin":"3px 3px 0px","-moz-transform-origin":"3px 3px 0px","-webkit-transform-origin":"3px 3px 0px","-o-transform-origin":"3px 3px 0px"})}})};SetTab=function(b,a,d){if("false"!==d){var c=d;$("."+c).remove();$("#"+c).empty();""!==b&&($("#ui-"+c).text(trim_text(b,40,3)),$("#ui-"+c).prop("title",b))}else c=
"tabs_"+counttab,sumtab++,$("#tabs").children(".ui-tabs-nav").append($("<li />").css("style","cursor:default;").append($("<a />").css("style","cursor:default;").attr({href:"#"+c,title:b,id:"ui-"+c}).append('<span style="float:right;left:10px;cursor:default;">'+trim_text(b,40,3)+"</span>").append('<span class="ui-icon ui-icon-document" style="float:left;top:5px;cursor:default;"></span>')).append($("<span />").attr({"class":"ui-icon ui-icon-close",style:"float:left;cursor:pointer"}).on("touchend click",
function(){CloseTab($(this).parent().attr("aria-controls"))}))),$("#tabs").append($("<div />").attr({id:c,style:"overflow:hide;width:"+(doc_width-18)+"px"}));$("#"+c).append("<div class='loader_tab' style='overflow:hide'><div>");a=a+"&tabid="+c;$("#tabs").tabs("refresh");"false"===d&&$("#tabs").tabs("option","active",$("#tabs").children(".ui-tabs-nav li").length-1);$("#"+c).attr({need_redraw:!0});$.ajax({url:a,type:"GET",success:function(b){"Not autorised"!==b?($.each($("#"+c).find(".ui-jqgrid"),
function(){$("#"+$(this).attr("id")).jqGrid("GridDestroy")}),$("#"+c).empty().css("text-align","left").attr({need_redraw:!0}),$("#"+c).append($(b)),redraw_document($(".ui-tabs-panel[aria-hidden='false']"))):$(location).prop("href",location.href)}});counttab++};CloseTab=function(b){var a=$("#ui-"+b).parent().closest("li").remove().attr("aria-controls");$("#tabs").tabs("refresh");sumtab--;redraw_document($(".ui-tabs-panel[aria-hidden='false']"));0===$(".ui-tabs-nav li[aria-selected='true']").length&&
(document.title=doc_title);$("#"+a).remove();$("."+b).remove();0!==sumtab||enable_menu||$(".slidebarmenu").SlidebarMenu("open")};replace_select_opt_group=function(b){"undefined"===typeof b&&(b=$("body"));$.each($(b).find("select option[value='GROUP_START']"),function(){$(this).replaceWith("<optgroup label='"+$(this).text()+"' >")});$.each($(b).find("select option[value='GROUP_END']"),function(){var b=$(this).parent(),d=b.children("option:selected");if("undefined"!==typeof b.html()){var c=$(b.html().split("</optgroup>").join("").split('<option value="GROUP_END"></option>').join("</optgroup>").split('<option role="option" value="GROUP_END"></option>').join("</optgroup>"));
...
"center").append($("<div />").addClass("ui-widget-header ui-state-hover ui-corner-all").height(2).width(150))}})};set_detail_tab=function(){$(".detail_tab").tabs({collapsible:!1,heightStyle:"fill",activate:function(b,a){"true"===$("#"+a.newTab.attr("aria-controls")).children(".grid_resizer_tabs").attr("need_update")&&($("#"+$("#"+a.newTab.attr("aria-controls")).children(".grid_resizer_tabs").attr("for")).jqGrid().trigger("reloadGrid",!0),$("#"+a.newTab.attr("aria-controls")).children(".grid_resizer_tabs").attr("need_update",
...
slidebar+";' title='\u0413\u043b\u0430\u0432\u043d\u043e\u0435 \u043c\u0435\u043d\u044e'><div class='ui-state-active navicon-line sb-toggle'></div><div class='ui-state-active navicon-line sb-toggle'></div><div class='ui-state-active navicon-line sb-toggle'></div></div>"),$(".sb-toggle").click(function(){$(".slidebarmenu").SlidebarMenu("toggle")})));redraw_document();$(document).tooltip({show:null,items:".btn-box-share",hide:{effect:""}});$("#loading").fadeOut()});$(window).resize(function(){$(".ui-tabs-panel").attr({need_redraw:!0});
doc_height=$(window).height();doc_width=$(window).width()-2;redraw_document($(".ui-tabs-panel[aria-hidden='false']"));enable_menu||$(".slidebarmenu").SlidebarMenu("resize")});$("#password").keyup(function(b){13===b.keyCode&&$("#logon_btn").click()});$(".iws_param").dialog({autoOpen:!1,modal:!0,minWidth:450,closeOnEscape:!0,resizable:!1,buttons:{"\u041f\u0440\u0438\u043c\u0435\u043d\u0438\u0442\u044c":function(){$("#btn_opt_cancel").button("option","disabled",!0);$("#btn_opt_save").button("option",
...
open:function(){$(".ui-dialog-buttonpane").find('button:contains("\u041e\u0442\u043c\u0435\u043d\u0430")').button({icons:{primary:"ui-icon-close"}}).prop("id","btn_opt_cancel");$(".ui-dialog-buttonpane").find('button:contains("\u041f\u0440\u0438\u043c\u0435\u043d\u0438\u0442\u044c")').button({icons:{primary:"ui-icon-disk"}}).prop("id","btn_opt_save");$(this).parent().css("z-index",805).parent().children(".ui-widget-overlay").css("z-index",800)}});$(".iws_about").dialog({autoOpen:!1,modal:!0,minWidth:650,
closeOnEscape:!0,resizable:!1,close:function(){$(this).dialog("close")},open:function(){$(this).parent().css("z-index",805).parent().children(".ui-widget-overlay").css("z-index",800)}});$("#themeselector").multiselect({multiple:!1,header:!1,selectedList:1});$("#editabled,#cache_enable,#slidebar_right").iosCheckbox();$("#random_theme").iosCheckbox({checked:function(){$("#themeselector").multiselect("disable")},unchecked:function(){$("#themeselector").multiselect("enable")}});$("#enable_menu").iosCheckbox({checked:function(){$("#slidebar_right").iosCheckbox("disable")},
unchecked:function(){$("#slidebar_right").iosCheckbox("enable")}});$("#renderer").slider({range:"min",value:$("#render_type").val(),min:0,max:3,step:1,slide:function(b,a){$.browser.msie&&2<=a.value?($("#render_type").val(2),$(this).slider({value:2})):$("#render_type").val(a.value)}}).height(8).children("a").css("border-radius","100%");$("#num_mounth").spinner({spin:function(b,a){if(6<a.value)return $(this).spinner("value",1),!1;if(1>a.value)return $(this).spinner("value",6),!1}});$("#num_reck").spinner({step:10,
spin:function(b,a){if(5E3<a.value)return $(this).spinner("value",1),!1;if(1>a.value)return $(this).spinner("value",5E3),!1}});$("#tabs").tabs({collapsible:!1,heightStyle:"fill",activate:function(b,a){null===doc_title&&(doc_title=document.title);document.title=doc_title+" [ "+$(a.newTab).children("a").attr("title")+" ]";redraw_document(a.newPanel)}}).find(".ui-tabs-nav").sortable({axis:"x",placeholder:"ui-state-highlight",distance:10,stop:function(){$("#tabs").tabs("refresh");redraw_document($(".ui-tabs-panel[aria-hidden='false']"))}}).disableSelection();
$("#logon_btn").button().click(function(b){var a=$("#username").val(),d=$("#password").val();$("#login_form").fadeOut(500);setTimeout(function(){$("#loading_text").text("\u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0430...")},500);setTimeout(function(){if(""===a.replace(/\s/g,""))return custom_alert("\u041d\u0435\u043e\u0431\u0445\u043e\u0434\u0438\u043c\u043e \u0443\u043a\u0430\u0437\u0430\u0442\u044c \u0438\u043c\u044f \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044f!"),$("#loading_text").empty(),
$("#login_form").fadeIn(500),!1;if(""===d.replace(/\s/g,""))return custom_alert("\u041d\u0435\u043e\u0431\u0445\u043e\u0434\u0438\u043c\u043e \u0443\u043a\u0430\u0437\u0430\u0442\u044c \u043f\u0430\u0440\u043e\u043b\u044c!"),$("#loading_text").empty(),$("#login_form").fadeIn(500),!1;if(!0===function(b){for(i=0;18>i;i++)if(-1<b.indexOf("<>()+[]{}:;|'\"~`-="[i]))return!0;return!1}(d))return custom_alert('\u041f\u0430\u0440\u043e\u043b\u044c \u0441\u043e\u0434\u0435\u0440\u0436\u0438\u0442 \u043e\u0434\u0438\u043d \u0438\u043b\u0438 \u043d\u0435\u0441\u043a\u043e\u043b\u044c\u043a\u043e \u0441\u0438\u043c\u0432\u043e\u043b\u043e\u0432 \u043a\u043e\u0442\u043e\u0440\u044b\u0435 \u043d\u0435\u0434\u043e\u043f\u0443\u0441\u0442\u0438\u043c\u044b \u0434\u043b\u044f \u043b\u043e\u0433\u0438\u043d\u0430 \u0432 \u0441\u0438\u0441\u0442\u0435\u043c\u0443. \u041d\u0430\u043f\u0440\u0438\u043c\u0435\u0440 \u0441\u0438\u043c\u0432\u043e\u043b\u044b "&#60;","&#62;" \u0430 \u0442\u0430\u043a\u0436\u0435 \u043d\u0435\u043a\u043e\u0442\u043e\u044b\u0435 \u0434\u0440\u0443\u0433\u0438\u0435 \u0441\u043f\u0435\u0446\u0438\u0430\u043b\u044c\u043d\u044b\u0435 \u0441\u0438\u043c\u0432\u043e\u043b\u044b.'),
...
style:"float: right;margin: 0px 5px 3px 0px;"}).button({icons:{primary:"ui-icon-print"},text:!1}).click(function(){var b=$(".ui-tabs-panel[aria-hidden='false'] .tab_main_content").find(".ui-jqgrid-view table, .FormGrid table, .chart").clone();b.removeAttr("height class top left");$(b).printThis({printContainer:!1,importCSS:!1,loadCSS:"/library/print.css",debug:!1})}));check_form=function(b){var a=!0;$.each(b.find("input[is_requred='true']"),function(){""===$.trim($(this).val())&&($(this).addClass("ui-state-error"),

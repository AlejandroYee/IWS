...
$(".slidebarmenu").SlidebarMenu("open")};redraw_document=function(b){$("body").width(doc_width).height(doc_height);$(".user_login").css({top:doc_height/2-175,left:doc_width/2-200});"undefined"===typeof b&&(b=$($(".ui-tabs-panel[aria-expanded='true']")));if(b.attr("need_redraw")||0===b.length)$("#tabs").tabs().height(doc_height-main_menu_higth-10),$("#tabs .ui-tabs-panel").height(doc_height-main_menu_higth-10).width(doc_width-20),$(".about_tabs").offset({top:doc_height-50}),$(".about_tabs_ver").offset({top:doc_height-
25}),b.children(".tab_main_content").height(doc_height-main_menu_higth-90).width(doc_width-20),b.attr({need_redraw:!1}).children(".navigation_header").height(30);$(".dialog_jqgrid_overlay,.ui-widget-overlay").height(doc_height-main_menu_higth-88).width(doc_width-24).offset({top:main_menu_higth+30+50,left:12});b.css("overflow","hidden");if(0<b.find(".help_content").length){var a=b.find(".help_content"),d=b.children(".ui-accordion-header"),c=doc_height-main_menu_higth-150-2.05*d.height()*(d.length-
1);a.height(doc_height-main_menu_higth-90).width(doc_width-20);d.width(doc_width-65);a.children(".ui-accordion-content").height(c).width(doc_width-87)}$.each(b.find(".grid_resizer, .grid_resizer_tabs"),function(){var b=$(this),a=b.attr("form_type"),c=b.attr("percent");b.attr("detail_sub_tab")?(c-=33/(doc_height/100),c=(doc_height-main_menu_higth-93)/100*c-23,doc_width_grid=doc_width-48,add_to_koeff=0):(c=90>c&&10<c||0<b.attr("percent_saved")?(doc_height-main_menu_higth-93)/100*c:doc_height-main_menu_higth-
93,doc_width_grid=doc_width-27,add_to_koeff=20);a="TREE_GRID_FORM_DETAIL"!==a&&"TREE_GRID_FORM"!==a?"none"!==b.children(".ui-jqgrid").find(".ui-search-toolbar").css("display")&&"TREE_GRID_FORM_MASTER"!==a?82+add_to_koeff:55+add_to_koeff:82;b.height(c).width(doc_width_grid);b.height(c).children(".ui-jqgrid").height(c-2).width(doc_width_grid).children(".ui-jqgrid-pager").height(25).width(doc_width_grid).parent().children(".ui-jqgrid-view").height(c-27).width(doc_width_grid).children(".ui-jqgrid-hdiv").width(doc_width_grid).parent().children(".ui-jqgrid-bdiv").height(c-
...
close:function(){$(this).dialog("close")},open:function(){$(".ui-dialog-buttonpane").find('button:contains("\u041e\u0442\u043c\u0435\u043d\u0430")').button({icons:{primary:"ui-icon-close"}}).prop("id","btn_opt_cancel");$(".ui-dialog-buttonpane").find('button:contains("\u041f\u0440\u0438\u043c\u0435\u043d\u0438\u0442\u044c")').button({icons:{primary:"ui-icon-disk"}}).prop("id","btn_opt_save");$(this).parent().css("z-index",805).parent().children(".ui-widget-overlay").css("z-index",800)}});$(".iws_about").dialog({autoOpen:!1,
modal:!0,minWidth:650,closeOnEscape:!0,resizable:!1,close:function(){$(this).dialog("close")},open:function(){$(this).parent().css("z-index",805).parent().children(".ui-widget-overlay").css("z-index",800)}});$("#themeselector").multiselect({multiple:!1,header:!1,selectedList:1});$("#random_theme").iosCheckbox({checked:function(){$("#themeselector").multiselect("enable")},unchecked:function(){$("#themeselector").multiselect("disable")}});$("#editabled,#cache_enable,#enable_menu").iosCheckbox();$("#renderer").slider({range:"min",
value:$("#render_type").val(),min:0,max:3,step:1,slide:function(b,a){$.browser.msie&&2<=a.value?($("#render_type").val(2),$(this).slider({value:2})):$("#render_type").val(a.value)}}).height(8).children("a").css("border-radius","100%");$("#num_mounth").spinner({spin:function(b,a){if(6<a.value)return $(this).spinner("value",1),!1;if(1>a.value)return $(this).spinner("value",6),!1}});$("#num_reck").spinner({step:10,spin:function(b,a){if(5E3<a.value)return $(this).spinner("value",1),!1;if(1>a.value)return $(this).spinner("value",
5E3),!1}});$("#tabs").tabs({collapsible:!1,heightStyle:"fill",activate:function(b,a){null===doc_title&&(doc_title=document.title);document.title=doc_title+" [ "+$(a.newTab).children("a").attr("title")+" ]";redraw_document(a.newPanel)}}).find(".ui-tabs-nav").sortable({axis:"x",placeholder:"ui-state-highlight",distance:10,stop:function(){$("#tabs").tabs("refresh");redraw_document($(".ui-tabs-panel[aria-expanded='true']"))}}).disableSelection();$("#logon_btn").button().click(function(b){var a=$("#username").val(),
d=$("#password").val();$("#login_form").fadeOut(500);setTimeout(function(){$("#loading_text").text("\u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0430...")},500);setTimeout(function(){""===a.replace(/\s/g,"")&&(custom_alert("\u041d\u0435\u043e\u0431\u0445\u043e\u0434\u0438\u043c\u043e \u0443\u043a\u0430\u0437\u0430\u0442\u044c \u0438\u043c\u044f \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044f!"),$("#loading_text").empty(),$("#login_form").fadeIn(500));""===d.replace(/\s/g,"")&&
(custom_alert("\u041d\u0435\u043e\u0431\u0445\u043e\u0434\u0438\u043c\u043e \u0443\u043a\u0430\u0437\u0430\u0442\u044c \u043f\u0430\u0440\u043e\u043b\u044c!"),$("#loading_text").empty(),$("#login_form").fadeIn(500));""!==a.replace(/\s/g,"")&&""!==d.replace(/\s/g,"")&&$.ajax({url:"ajax.saveparams.php?act=login",datatype:"json",data:{username:$("#username").val(),password:$("#password").val()},cache:!1,type:"POST",success:function(b){"true"!=b?(custom_alert("\u041d\u0435\u0432\u0435\u0440\u043d\u043e\u0435 \u0438\u043c\u044f \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044f \u0438\u043b\u0438 \u043f\u0430\u0440\u043e\u043b\u044c!"),

...
50}),$(".about_tabs_ver").offset({top:doc_height-25}),b.children(".tab_main_content").height(doc_height-main_menu_higth-90).width(doc_width-20),b.attr({need_redraw:!1}).children(".navigation_header").height(30);$(".dialog_jqgrid_overlay,.ui-widget-overlay").height(doc_height-main_menu_higth-88).width(doc_width-24).offset({top:main_menu_higth+30+50,left:12});b.css("overflow","hidden");if(0<b.find(".help_content").length){var a=b.find(".help_content"),d=b.children(".ui-accordion-header"),c=doc_height-
main_menu_higth-150-2.05*d.height()*(d.length-1);a.height(doc_height-main_menu_higth-90).width(doc_width-20);d.width(doc_width-65);a.children(".ui-accordion-content").height(c).width(doc_width-87)}$.each(b.find(".grid_resizer, .grid_resizer_tabs"),function(){var b=$(this),a=b.attr("form_type"),c=b.attr("percent");b.attr("detail_sub_tab")?(c-=33/(doc_height/100),c=(doc_height-main_menu_higth-93)/100*c-23,doc_width_grid=doc_width-48,add_to_koeff=0):(c=90>c&&10<c||0<b.attr("percent_saved")?(doc_height-
main_menu_higth-93)/100*c:doc_height-main_menu_higth-93,doc_width_grid=doc_width-27,add_to_koeff=20);a="TREE_GRID_FORM_DETAIL"!==a&&"TREE_GRID_FORM"!==a?"none"!==b.children(".ui-jqgrid").find(".ui-search-toolbar").css("display")&&"TREE_GRID_FORM_MASTER"!==a?82+add_to_koeff:55+add_to_koeff:82;b.height(c).width(doc_width_grid);b.height(c).children(".ui-jqgrid").height(c-2).width(doc_width_grid).children(".ui-jqgrid-pager").height(25).width(doc_width_grid).parent().children(".ui-jqgrid-view").height(c-
27).width(doc_width_grid).children(".ui-jqgrid-hdiv").width(doc_width_grid).parent().children(".ui-jqgrid-bdiv").height(c-a).width(doc_width_grid);var d=b.find(".frozen-div");$.each(d,function(){var a=d.children("table").width(),c=b.find(".ui-jqgrid-titlebar").outerHeight();d.width(a).css("top",c+1+"px");d.parent().children(".frozen-bdiv").width(a).height(b.find(".ui-jqgrid-bdiv")[0].clientHeight+1).css("top",c+b.find(".ui-jqgrid-hbox").outerHeight()+1+"px")})});$.each($(".grid_resizer[form_type$='_DETAIL'] div.ui-jqgrid-titlebar, .detail_tab .ui-tabs-nav"),
function(){1>$(this).children("div[control='window']").length&&(button_htm_down=$("<span>").attr({style:"float:right;cursor: pointer","class":"ui-icon ui-icon-circle-triangle-n",title:"\u0420\u0430\u0441\u043f\u0430\u0445\u043d\u0443\u0442\u044c \u043d\u0430 \u0432\u0441\u0435 \u043e\u043a\u043d\u043e/\u0432\u043e\u0441\u0441\u0442\u0430\u043d\u043e\u0432\u0438\u0442\u044c"}).click(function(){upper=$(".ui-tabs-panel[aria-expanded='true'] .grid_resizer:first");downn=$(".ui-tabs-panel[aria-expanded='true'] .grid_resizer:last,.ui-tabs-panel[aria-expanded='true'] .grid_resizer_tabs");
